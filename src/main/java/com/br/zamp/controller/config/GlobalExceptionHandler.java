...
public class GlobalExceptionHandler {
  ...
  @ResponseBody
  public ErrorResponse handleAuthorizationServiceException(
  ...
  public ErrorResponse handleNotFoundException(
      ObjectNotFoundException ex, HttpServletResponse response) {
  ...
  @ResponseBody
  public ErrorResponse handleDuplicatedObjectException(
      DuplicatedObjectException ex, HttpServletResponse response) {
  ...
  public ErrorResponse handleMethodArgumentNotValidException(
    ...
    if (ex.getFieldError() != null && ex.getFieldError().getDefaultMessage() != null) {
      validations.put(
          ex.getFieldError().getField(), List.of(ex.getFieldError().getDefaultMessage()));
    }
  ...
  @ResponseBody
  public ErrorResponse handleValidationExceptionException(
      ValidationException ex, HttpServletResponse response) {
    response.setStatus(HttpStatus.BAD_REQUEST.value());
  ...
  public ErrorResponse handleClassCastException(
      ClassCastException ex, HttpServletResponse response) {
